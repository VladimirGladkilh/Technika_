...
public class TechnikaTestContainer extends TestContainer {

    public TechnikaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/technika/app.properties",
    ...
    public static class Common extends TechnikaTestContainer {

        public static final TechnikaTestContainer.Common INSTANCE = new TechnikaTestContainer.Common();
